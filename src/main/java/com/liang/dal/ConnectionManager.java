...
public class ConnectionManager {
    ...
    private final static String user = "liang";
    // Password for the user.
    private final static String password = "Q13605255131q!";
    // URI to your database server. If running on the same machine, then this is "localhost".
    private final static String hostName = "myrds3.cmfisjqtu9mb.us-west-1.rds.amazonaws.com";
    // Port to your database server. By default, this is 3306.
    private final static int port= 3306;
    // Name of the MySQL schema that contains your tables.
    private final static String schema = "Fitbit";
...
//                    "jdbc:mysql://" + hostName+ ":" + port + "/" + this.schema,
